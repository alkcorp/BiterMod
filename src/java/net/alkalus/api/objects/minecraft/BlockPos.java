package net.alkalus.api.objects.minecraft;
...
public class BlockPos implements Serializable{
	...
	public BlockPos(Entity b) {
		this ((int)b.posX, (int)b.posY, (int)b.posZ, b.worldObj);
	}
	...
	public boolean isAir() {
		if (this.world != null) {
			return world.isAirBlock(xPos, yPos, zPos);
		}
		return false;
	}
