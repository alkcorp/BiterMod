...
public class ReflectionUtils {
	...
	private static void dumpClassInfo(Class<?> aClass) {
		...
		for (Method method : methods) {
			System.out.println(method.getName()+" | "+ArrayUtils.toString(method.getParameterTypes()));
		}
		...
		for (Constructor<?> c : consts) {
			System.out.println(c.getName()+" | "+c.getParameterCount()+" | "+ArrayUtils.toString(c.getParameterTypes()));
		}
	}
